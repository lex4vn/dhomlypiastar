<?php
// HTTP
define('HTTP_SERVER', 'https://dhomlypiastar-lex4vn.c9users.io/admin/');
define('HTTP_CATALOG', 'https://dhomlypiastar-lex4vn.c9users.io/');

// HTTPS
define('HTTPS_SERVER', 'https://dhomlypiastar-lex4vn.c9users.io/admin/');
define('HTTPS_CATALOG', 'https://dhomlypiastar-lex4vn.c9users.io/');
