...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {
		...
		$data['entry_name1'] = $this->language->get('entry_name1');
		$data['entry_name2'] = $this->language->get('entry_name2');
		$data['entry_product'] = $this->language->get('entry_product');
		$data['entry_product1'] = $this->language->get('entry_product1');
		...
		if (isset($this->error['name1'])) {
			$data['error_name'] = $this->error['name1'];
		} else {
			$data['error_name'] = '';
		}
		if (isset($this->error['name2'])) {
			$data['error_name'] = $this->error['name2'];
		} else {
			$data['error_name'] = '';
		}
		...
		if (isset($this->request->post['banner_image'])) {
			...
			$banner_image = $module_info['banner_image'];
		} else {
			$banner_image = '';
		}
		...
		$data['banner_thumb'] = $this->model_tool_image->resize($thumb, 100, 100);		
		...
		if (isset($this->request->post['viewall'])) {
			$data['viewall'] = $this->request->post['viewall'];
		} elseif (!empty($module_info)) {
			$data['viewall'] = $module_info['viewall'];
		} else {
			$data['viewall'] = '';
		}
