...
<div class="container">
	<div class="row">
	<?php 
	$image = '<img class="img-responsive" src="'.$banner_image.'" alt="'.$name.'" title="'.$name.'"/>';
		if($align == 'left'){ 
			$left = '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 banner-image">'.$image.'</div>';
			$right = '';
		}else{
			$left = '';
			$right = '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 banner-image">'.$image.'</div>';
		}
	?>
	<?php echo $left; ?>
...
<div class="view-all"><a href="<?php echo $viewall; ?>"><span>Xem tất cả</span></a></div>
</div>
